...
const params = useParams()
  ...
  const handleRemoveImage = (index) => {
    setFormData({
      ...formData,
      imageUrls: formData.imageUrls.filter((_, i) => i !== index), // '-' remove
    })
  }
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if(+formData.regularPrice < +formData.discountPrice) return setError('Discount price must be lower than regular price')// + will convert string to number
      setLoading(true);
      const newData = {
        ...formData,
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
      ...
      <div className="flex flex-col flex-1 gap-4 font-medium">
        ...
        <p disabled = {loading} className='text-red-700 text-sm'>{imageUploadError && imageUploadError}</p>
